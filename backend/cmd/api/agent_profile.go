...
// uploadAgentProfilePhotoHandler handles profile photo uploads for agents
func (app *application) uploadAgentProfilePhotoHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = app.writeJSON(w, http.StatusOK, envelope{
		"message":       "agent profile photo uploaded successfully",
...
// getAgentProfilePhotoHandler retrieves the agent's current profile photo URL
func (app *application) getAgentProfilePhotoHandler(w http.ResponseWriter, r *http.Request) {
	user := app.contextGetUser(r)
...
// deleteAgentProfilePhotoHandler removes the agent's profile photo
func (app *application) deleteAgentProfilePhotoHandler(w http.ResponseWriter, r *http.Request) {
	user := app.contextGetUser(r)
	...
	err = app.writeJSON(w, http.StatusOK, envelope{
		"message": "agent profile photo deleted successfully",
	}, nil)
	if err != nil {
		app.serverErrorResponse(w, r, err)
	}
